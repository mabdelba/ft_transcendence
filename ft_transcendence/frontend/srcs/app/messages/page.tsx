			...
			<div className="h-auto w-full grid grid-cols-1 pt-2 2xl:pt-4">
			  {showArray.map((obj: any) => (
				<button
				  ...
				  key={obj.id}
				  className={`h-14  2xl:h-[68px] truncate rounded-br-full rounded-tr-full rounded-bl-full text-xs 2xl:text-base flex flex-row justify-center md:justify-start space-x-3 2xl:space-x-6 md:pl-5 2xl:pl-7 items-center transition-all duration-500 tracking-wide  ${
