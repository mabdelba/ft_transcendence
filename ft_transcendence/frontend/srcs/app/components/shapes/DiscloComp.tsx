		...
		<div className="w-full h-auto  border ">
			<div className="w-full font-Orbitron  NeonShadowBord">
				<Disclosure>
					{({ open }) => (
						<>
							<Disclosure.Button className={`flex w-full h-auto ${props.textColor} justify-between  ${props.hoverColor}  items-center p-5  md:p-10 text-left text-xs md:text-xl font-medium`}>
