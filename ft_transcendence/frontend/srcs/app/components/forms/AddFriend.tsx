...
function AddFriend(props: newType){
    ...
    <div className="h-full w-full NeonShadowBord flex flex-col ">
        <div className={`w-full ${props.state == 2 ? 'h-1/5' : 'h-1/2'} flex justify-center items-center text-xs  xl:text-xl`}>
            {
                props.state == 0 ?
        ...
        <div className={`w-full ${props.state == 2 ? 'h-4/5' : 'h-1/2'}   flex justify-center items-start`}>
            {
                props.state == 0 ? 
