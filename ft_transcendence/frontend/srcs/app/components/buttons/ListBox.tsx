...
function MyListbox(props: newType) {
  ...
  useEffect(() => {
    if (selected.name == 'Friends Messages') props.setSelected(0);
    else if (selected.name == 'Groups Messages') props.setSelected(1);
                ...
                {people.map((person, personIdx) => (
                  ...
                  >
                    {({ selected }) => (
                      <>
                        <span
                          className={`flex flex-row text-[8px] xl:text-base space-x-1 xl:space-x-2 justify-center items-center ${
